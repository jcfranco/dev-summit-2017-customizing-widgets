...
import NavigationToggle = require("esri/widgets/NavigationToggle");
...
class VintageNavigationToggle extends declared(NavigationToggle) {
  ...
  render() {
    ...
    const iconClasses = {
      [CSS.panIcon]: this.viewModel.navigationMode === "pan",
      [CSS.rotationIcon]: this.viewModel.navigationMode === "rotate"
    };
...
export = VintageNavigationToggle;
